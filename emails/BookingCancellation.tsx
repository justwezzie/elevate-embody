...
export function BookingCancellationEmail({ booking }: Props) {
  ...
  return (
    <Html>
      <Head />
      <Preview>Your {session.title} booking has been cancelled</Preview>
      <Body style={{ backgroundColor: '#F7F7F8', fontFamily: 'sans-serif' }}>
        <Container style={{ maxWidth: '560px', margin: '0 auto', padding: '40px 20px' }}>
          ...
          <Text style={{ color: '#4E31AA', marginTop: 0 }}>
            Hi {user.full_name ?? 'there'}, your booking has been cancelled and a refund of £{price} has been issued.
          </Text>
          <Hr />
          <Section>
            ...
            <Text style={{ margin: '8px 0' }}><strong>Refund:</strong> £{price} (allow 5–10 business days)</Text>
          </Section>
          <Hr />
